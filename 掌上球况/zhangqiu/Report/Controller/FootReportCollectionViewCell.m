//
//  FootReportCollectionViewCell.m
//  zhangqiu
//
...
@interface FootReportCollectionViewCell ()<UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, retain) TagView *viewTag;
@end

@implementation FootReportCollectionViewCell
- (void)dealloc
{
    [_infoArr release];
    [_mainTableV release];
...
//    }
    ...
    self.mainTableV = [[[UITableView alloc]initWithFrame:CGRectMake(0, liuHeight + sideCellHeight, myWidth, myHeight - (liuHeight + newsCellImageLeft * 2) - (liuHeight) - tabBarheight - sideCellHeight) style:UITableViewStyleGrouped]autorelease];
...
- (nullable UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    [label release];
    view.backgroundColor = [UIColor colorWithWhite:0.603 alpha:1.000];
    return view;
}
